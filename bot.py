...
# Cambiar al directorio del archivo en ejecución
...
async def ch(message: types.Message):
    ...
    try:
        ...
        #b = session.get('https://hizero.com.au/wp-admin/admin-ajax.php', proxies=proxies).text

        s = session.post('https://hizero.com.au/?wc-ajax=checkout', headers=headers)
        r = s.json()
        Guid = r['guid']
        Muid = r['muid']
        Sid = r['sid']
        ...
        pr = session.post('https://hizero.com.au/?wc-ajax=checkout',
        ...
        rx = session.post('https://hizero.com.au/?wc-ajax=checkout',
